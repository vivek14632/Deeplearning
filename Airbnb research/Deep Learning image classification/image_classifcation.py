...
path = "/Users/jaideep/Desktop/Scrapped images"
...
for file in dirs:
    ...
    if not file.startswith('.') and file != 'Thumbs.db':
        img = Image.open('/Users/jaideep/Desktop/Scrapped images/'+str(file))
...
df_list_sort.to_csv("/Users/jaideep/Desktop/Airbnb_cnn_classification_all_sorted.csv", sep=',')
